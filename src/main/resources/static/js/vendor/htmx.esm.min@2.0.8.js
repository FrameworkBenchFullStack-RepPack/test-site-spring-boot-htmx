 ...
 * Original file: /npm/htmx.org@2.0.8/dist/htmx.esm.js
 *
...
var htmx = (function () {
  ...
  function getAttributeValueWithDisinheritance(e, t, n) {
    ...
    var s = getAttributeValue(t, "hx-inherit");
    if (e !== t) {
      if (htmx.config.disableInheritance)
        return s && ("*" === s || s.split(" ").indexOf(n) >= 0) ? r : null;
  ...
  function makeFragment(e) {
    ...
    if ("html" === n) {
      ...
      const t = parseHTML(e);
      (takeChildrenFor(r, t.body), (r.title = t.title));
    } else if ("body" === n) {
      r = new DocumentFragment();
      const e = parseHTML(t);
      (takeChildrenFor(r, e.body), (r.title = e.title));
    } else {
      const e = parseHTML(
      ...
      ((r = e.querySelector("template").content), (r.title = e.title));
  ...
  function find(e, t) {
    return "string" != typeof e ? e.querySelector(t) : find(getDocument(), e);
  }
  ...
  function closest(e, t) {
    return (e = asElement(resolveTarget(e))) ? e.closest(t) : null;
  }
  ...
  function querySelectorAllExt(e, t, n) {
    ...
    const r = [];
    {
      ...
      for (let o = 0; o < t.length; o++) {
        ...
        "," !== s || 0 !== e
          ? "<" === s
            ? e++
            : "/" === s && o < t.length - 1 && ">" === t[o + 1] && e--
          : (r.push(t.substring(n, o)), (n = o + 1));
      }
    ...
    const o = [],
      s = [];
    for (; r.length > 0; ) {
      const t = normalizeSelector(r.shift());
      let a;
      (0 === t.indexOf("closest ")
        ? (a = closest(asElement(e), normalizeSelector(t.slice(8))))
        : 0 === t.indexOf("find ")
          ? (a = find(asParentNode(e), normalizeSelector(t.slice(5))))
          : "next" === t || "nextElementSibling" === t
            ? (a = asElement(e).nextElementSibling)
            : 0 === t.indexOf("next ")
              ? (a = scanForwardQuery(e, normalizeSelector(t.slice(5)), !!n))
              : "previous" === t || "previousElementSibling" === t
                ? (a = asElement(e).previousElementSibling)
                : 0 === t.indexOf("previous ")
                  ? (a = scanBackwardsQuery(
                      e,
                      normalizeSelector(t.slice(9)),
                      !!n,
                    ))
                  : "document" === t
                    ? (a = document)
    ...
    if (s.length > 0) {
      const t = s.join(","),
        r = asParentNode(getRootNode(e, !!n));
      o.push(...toArray(r.querySelectorAll(t)));
    }
    return o;
  }
  ...
  function resolveTarget(e, t) {
    return "string" == typeof e ? find(asParentNode(t) || document, e) : e;
  }
  ...
  function addEventListenerImpl(e, t, n, r) {
    ready(function () {
      const o = processEventArgs(e, t, n, r);
      o.target.addEventListener(o.event, o.listener, o.options);
    });
    return isFunction(t) ? t : n;
  }
  ...
  function findThisElement(e, t) {
    return asElement(
      getClosestMatch(e, function (e) {
        return null != getAttributeValue(asElement(e), t);
      }),
    );
  }
  ...
  function oobSwap(e, t, n, r) {
    ...
    const a = querySelectorAllExt(r, o, !1);
    return (
      a.length
        ? (forEach(a, function (e) {
            let r;
            const o = t.cloneNode(!0);
            ((r = getDocument().createDocumentFragment()),
              r.appendChild(o),
              isInlineSwap(s, e) || (r = asParentNode(o)));
            const a = { shouldSwap: !0, target: e, fragment: r };
            triggerEvent(e, "htmx:oobBeforeSwap", a) &&
              ((e = a.target),
              a.shouldSwap &&
                (handlePreservedElements(r),
                swapWithStyle(s, e, e, r, n),
                restorePreservedElements()),
              forEach(n.elts, function (e) {
                triggerEvent(e, "htmx:oobAfterSwap", a);
              }));
          }),
  ...
  function restorePreservedElements() {
    ...
    if (e) {
      for (const t of [...e.children]) {
        const e = find("#" + t.id);
        (e.parentNode.moveBefore(t, e), e.remove());
      }
      e.remove();
    }
  }
  function handlePreservedElements(e) {
    forEach(findAll(e, "[hx-preserve], [data-hx-preserve]"), function (e) {
      const t = getAttributeValue(e, "id"),
        n = getDocument().getElementById(t);
      if (null != n)
        if (e.moveBefore) {
    ...
    (t.timeout && clearTimeout(t.timeout),
      t.listenerInfos &&
        forEach(t.listenerInfos, function (e) {
          e.on && removeEventListenerImpl(e.on, e.trigger, e.listener);
        }),
      deInitOnHandlers(e),
      forEach(Object.keys(t), function (e) {
        "firstInitCompleted" !== e && delete t[e];
      }));
  }
  ...
  function swapOuterHTML(e, t, n) {
    if ("BODY" === e.tagName) return swapInnerHTML(e, t, n);
    let r;
    const o = e.previousSibling,
      s = parentElt(e);
    if (s) {
      for (
        insertNodesBefore(s, e, t, n),
          r = null == o ? s.firstChild : o.nextSibling,
  ...
  function swapWithStyle(e, t, n, r, o) {
    switch (e) {
      ...
      case "delete":
        return void swapDelete(n);
      default:
        var s = getExtensions(t);
        for (let t = 0; t < s.length; t++) {
          const a = s[t];
          try {
            const t = a.handleSwap(e, n, r, o);
            if (t) {
              if (Array.isArray(t))
                for (let e = 0; e < t.length; e++) {
                  ...
                  n.nodeType !== Node.TEXT_NODE &&
                    ...
                    o.tasks.push(makeAjaxLoadTask(n));
                }
              return;
            }
          } catch (e) {
  ...
  function findAndSwapOobElements(e, t, n) {
    ...
    return (
      forEach(r, function (e) {
        if (htmx.config.allowNestedOobSwaps || null === e.parentElement) {
          const r = getAttributeValue(e, "hx-swap-oob");
          null != r && oobSwap(r, e, t, n);
        } else
  ...
  function swap(e, t, n, r) {
    ...
    let o = null,
      ...
      a = function () {
        ...
        i = {
          elt: a,
          start: a ? a.selectionStart : null,
          end: a ? a.selectionEnd : null,
        };
        const l = makeSettleInfo(e);
        if ("textContent" === n.swapStyle) e.textContent = t;
        else {
          let o = makeFragment(t);
          if (
            ((l.title = r.title || o.title),
            r.historyRequest &&
              (o =
                o.querySelector("[hx-history-elt],[data-hx-history-elt]") || o),
            r.selectOOB)
          ) {
          ...
          if (
            (findAndSwapOobElements(o, l, s),
            forEach(findAll(o, "template"), function (e) {
              e.content &&
                findAndSwapOobElements(e.content, l, s) &&
                e.remove();
            }),
            r.select)
          ) {
            const e = getDocument().createDocumentFragment();
            (forEach(o.querySelectorAll(r.select), function (t) {
              e.appendChild(t);
            }),
              (o = e));
          }
          (handlePreservedElements(o),
            swapWithStyle(n.swapStyle, r.contextElement, e, o, l),
            restorePreservedElements());
        }
        if (i.elt && !bodyContains(i.elt) && getRawAttribute(i.elt, "id")) {
          const e = document.getElementById(getRawAttribute(i.elt, "id")),
            t = {
              preventScroll:
          ...
          if (e) {
            if (i.start && e.setSelectionRange)
              try {
                e.setSelectionRange(i.start, i.end);
              } catch (e) {}
            e.focus(t);
          }
        }
        (e.classList.remove(htmx.config.swappingClass),
          forEach(l.elts, function (e) {
            (e.classList && e.classList.add(htmx.config.settlingClass),
              triggerEvent(e, "htmx:afterSwap", r.eventInfo));
          }),
          maybeCall(r.afterSwapCallback),
          n.ignoreTitle || handleTitle(l.title));
        const c = function () {
          if (
            (forEach(l.tasks, function (e) {
              e.call();
            }),
            forEach(l.elts, function (e) {
              (e.classList && e.classList.remove(htmx.config.settlingClass),
                triggerEvent(e, "htmx:afterSettle", r.eventInfo));
            }),
            r.anchor)
          ) {
            const e = asElement(resolveTarget("#" + r.anchor));
            e && e.scrollIntoView({ block: "start", behavior: "auto" });
          }
          (updateScrollState(l.elts, n),
            maybeCall(r.afterSettleCallback),
            maybeCall(o));
        };
        n.settleDelay > 0 ? getWindow().setTimeout(c, n.settleDelay) : c();
      },
      i = htmx.config.globalViewTransitions;
    n.hasOwnProperty("transition") && (i = n.transition);
    ...
    try {
      n?.swapDelay && n.swapDelay > 0
        ? getWindow().setTimeout(a, n.swapDelay)
        : a();
    } catch (e) {
      throw (
    ...
    if (0 === r.indexOf("{")) {
      ...
      for (const t in e)
        if (e.hasOwnProperty(t)) {
          let r = e[t];
          (isRawObject(r)
            ? (n = void 0 !== r.target ? r.target : n)
            : (r = { value: r }),
            triggerEvent(n, t, r));
        }
    } else {
      const e = r.split(",");
      for (let t = 0; t < e.length; t++) triggerEvent(n, e[t].trim(), []);
    }
  }
  const WHITESPACE = /\s/,
  ...
  function tokenizeString(e) {
    ...
    for (; n < e.length; ) {
      ...
      } else if (-1 !== STRINGISH_START.indexOf(e.charAt(n))) {
        const o = e.charAt(n);
        r = n;
  ...
  function maybeGenerateConditional(e, t, n) {
    if ("[" === t[0]) {
      ...
      for (; t.length > 0; ) {
        ...
        (isPossibleRelativeReference(a, s, n)
          ? (o +=
              "((" +
              n +
              "." +
    ...
    do {
      ...
      if ("" !== n)
        if ("every" === n) {
          ...
          (consumeUntil(o, NOT_WHITESPACE),
            (t.pollInterval = parseInterval(consumeUntil(o, /[,\[\s]/))),
            consumeUntil(o, NOT_WHITESPACE),
            (s = maybeGenerateConditional(e, o, "event")) &&
              (t.eventFilter = s),
            r.push(t));
        } else {
          const t = { trigger: n };
          ...
          for (
            ...
            if ("changed" === n) t.changed = !0;
              ...
              if ((o.shift(), COMBINED_SELECTOR_START.test(o[0])))
                var a = consumeCSSSelector(o);
              else if (
                "closest" === (a = consumeUntil(o, WHITESPACE_OR_COMMA)) ||
                "find" === a ||
                "next" === a ||
                "previous" === a
              ) {
              ...
              "target" === n && ":" === o[0]
                ? (o.shift(), (t.target = consumeCSSSelector(o)))
                : "throttle" === n && ":" === o[0]
                  ? (o.shift(),
                    (t.throttle = parseInterval(
                      consumeUntil(o, WHITESPACE_OR_COMMA),
                    )))
                  : "queue" === n && ":" === o[0]
                    ? (o.shift(),
                      (t.queue = consumeUntil(o, WHITESPACE_OR_COMMA)))
                    : "root" === n && ":" === o[0]
                      ? (o.shift(), (t[n] = consumeCSSSelector(o)))
                      : "threshold" === n && ":" === o[0]
                        ? (o.shift(),
                          (t[n] = consumeUntil(o, WHITESPACE_OR_COMMA)))
  ...
  function isLocalLink(e) {
    return (
      ...
      0 !== getRawAttribute(e, "href").indexOf("#")
    );
  }
  ...
  function boostElement(e, t, n) {
    if (
      ...
      ("FORM" === e.tagName &&
        "dialog" !== String(getRawAttribute(e, "method")).toLowerCase())
    ) {
      let r, o;
      if (((t.boosted = !0), "A" === e.tagName))
        ((r = "get"), (o = getRawAttribute(e, "href")));
      else {
        const t = getRawAttribute(e, "method");
        ((r = t ? t.toLowerCase() : "get"),
          (o = getRawAttribute(e, "action")),
          (null != o && "" !== o) || (o = location.href),
          "get" === r && o.includes("?") && (o = o.replace(/\?[^#]+/, "")));
      }
      n.forEach(function (n) {
        addEventListener(
          ...
          function (e, t) {
            const n = asElement(e);
            eltIsDisabled(n) ? cleanUpElement(n) : issueAjaxRequest(r, o, n, t);
          },
          t,
          n,
          !0,
  ...
  function shouldCancel(e, t) {
    ...
    if ("click" === e.type) {
      const e = t.closest('input[type="submit"], button');
      if (e && e.form && "submit" === e.type) return !0;
      const n = t.closest("a"),
        r = /^#.+/;
      if (n && n.href && !r.test(n.getAttribute("href"))) return !0;
    }
    return !1;
  }
  ...
  function addEventListener(e, t, n, r, o) {
    const s = getInternalData(e);
    let a;
    ((a = r.from ? querySelectorAllExt(e, r.from) : [e]),
      r.changed &&
        ("lastValue" in s || (s.lastValue = new WeakMap()),
        a.forEach(function (e) {
          (s.lastValue.has(r) || s.lastValue.set(r, new WeakMap()),
            s.lastValue.get(r).set(e, e.value));
        })),
      forEach(a, function (a) {
        const i = function (n) {
          if (!bodyContains(e)) return void a.removeEventListener(r.trigger, i);
          if (ignoreBoostedAnchorCtrlClick(e, n)) return;
          if (
            ((o || shouldCancel(n, a)) && n.preventDefault(),
            maybeFilterEvent(r, e, n))
          )
            return;
          const l = getInternalData(n);
          if (
            ((l.triggerSpec = r),
            ...
            if (
              ...
              r.target && n.target && !matches(asElement(n.target), r.target))
            )
              return;
            if (r.once) {
            ...
            r.throttle > 0
              ? s.throttle ||
                ...
                t(e, n),
                (s.throttle = getWindow().setTimeout(function () {
                  s.throttle = null;
                }, r.throttle)))
              : r.delay > 0
                ? (s.delayed = getWindow().setTimeout(function () {
                    (triggerEvent(e, "htmx:trigger"), t(e, n));
                  }, r.delay))
                : (triggerEvent(e, "htmx:trigger"), t(e, n));
          }
        };
        (null == n.listenerInfos && (n.listenerInfos = []),
          n.listenerInfos.push({ trigger: r.trigger, listener: i, on: a }),
          a.addEventListener(r.trigger, i));
      }));
  }
    ...
    return (
      forEach(VERBS, function (o) {
        if (hasAttribute(e, "hx-" + o)) {
          const s = getAttributeValue(e, "hx-" + o);
          ((r = !0),
            (t.path = s),
            (t.verb = o),
            n.forEach(function (n) {
              addTriggerHandler(e, n, t, function (e, t) {
                const n = asElement(e);
                eltIsDisabled(n)
                  ? cleanUpElement(n)
                  : issueAjaxRequest(o, s, n, t);
              });
            }));
        }
      }),
  ...
  function addTriggerHandler(e, t, n, r) {
    if ("revealed" === t.trigger)
      ...
      n.firstInitCompleted || "load" !== t.trigger
        ? t.pollInterval > 0
  ...
  function getRelatedFormData(e) {
    ...
    return n ? getInternalData(n) : void 0;
  }
  ...
  function addHxOnEventHandler(e, t, n) {
    ...
    const s = function (t) {
      maybeEval(e, function () {
        eltIsDisabled(e) || (o || (o = new Function("event", n)), o.call(e, t));
      });
    };
    (e.addEventListener(t, s), r.onHandlers.push({ event: t, listener: s }));
  }
      ...
      if (startsWith(n, "hx-on") || startsWith(n, "data-hx-on")) {
        ...
        if ("-" === o || ":" === o) {
          ...
          (startsWith(o, ":")
            ...
            : startsWith(o, "-")
              ? (o = "htmx:" + o.slice(1))
              : startsWith(o, "htmx-") && (o = "htmx:" + o.slice(5)),
            addHxOnEventHandler(e, o, r));
        }
      }
    }
  }
  function initNode(e) {
    ...
    const t = getInternalData(e),
      n = getTriggerSpecs(e);
    (processVerbs(e, t, n) ||
      ("true" === getClosestAttributeValue(e, "hx-boost")
        ? boostElement(e, t, n)
        : hasAttribute(e, "hx-trigger") &&
          n.forEach(function (n) {
            addTriggerHandler(e, n, t, function () {});
          })),
      ("FORM" === e.tagName ||
        ("submit" === getRawAttribute(e, "type") && hasAttribute(e, "form"))) &&
  ...
  function maybeDeInitAndHash(e) {
    ...
    const t = getInternalData(e),
      n = attributeHash(e);
    return t.initHash !== n && (deInitNode(e), (t.initHash = n), !0);
  }
  function processNode(e) {
    if (eltIsDisabled((e = resolveTarget(e)))) return void cleanUpElement(e);
    const t = [];
  ...
  function withExtensions(e, t, n) {
    forEach(getExtensions(e, [], n), function (e) {
      try {
        t(e);
      } catch (e) {
        logError(e);
  ...
  function triggerEvent(e, t, n) {
    ((e = resolveTarget(e)), null == n && (n = {}), (n.elt = e));
    ...
    const s = kebabEventName(t);
    if (o && s !== t) {
      const t = makeEvent(s, r.detail);
      o = o && e.dispatchEvent(t);
    }
    return (
      withExtensions(asElement(e), function (e) {
        o = o && !1 !== e.onEvent(t, r) && !r.defaultPrevented;
      }),
      o
    );
  }
  ...
  function saveToHistoryCache(e, t) {
    ...
    if (htmx.config.historyCacheSize <= 0)
      return void sessionStorage.removeItem("htmx-history-cache");
    e = normalizePath(e);
    const s = parseJSON(sessionStorage.getItem("htmx-history-cache")) || [];
    for (let t = 0; t < s.length; t++)
      if (s[t].url === e) {
        s.splice(t, 1);
        break;
      }
    const a = { url: e, content: n, title: r, scroll: o };
    for (
      triggerEvent(getDocument().body, "htmx:historyItemCreated", {
        ...
        s.push(a);
      s.length > htmx.config.historyCacheSize;
    )
      s.shift();
    for (; s.length > 0; )
      try {
        sessionStorage.setItem("htmx-history-cache", JSON.stringify(s));
        break;
      } catch (e) {
  ...
  function pushUrlIntoHistory(e) {
    (htmx.config.getCacheBusterParam &&
      (endsWith((e = e.replace(/org\.htmx\.cache-buster=[^&]*&?/, "")), "&") ||
        endsWith(e, "?")) &&
      (e = e.slice(0, -1)),
  ...
  function restoreHistory(e) {
    ...
    const t = getCachedHistory((e = e || location.pathname + location.search));
    if (t) {
      const n = {
          swapStyle: "innerHTML",
          swapDelay: 0,
  ...
  function removeRequestIndicators(e, t) {
    (forEach(e.concat(t), function (e) {
      ...
      forEach(e, function (e) {
        0 === getInternalData(e).requestCount &&
  ...
  function removeValueFromFormData(e, t, n) {
    if (null != e && null != t) {
      let r = n.getAll(e);
      ((r = Array.isArray(t)
        ? r.filter((e) => t.indexOf(e) < 0)
        : r.filter((e) => e !== t)),
        n.delete(e),
        forEach(r, (t) => n.append(e, t)));
    }
  }
  function getValueFromInput(e) {
    return e instanceof HTMLSelectElement && e.multiple
      ? toArray(e.querySelectorAll("option:checked")).map(function (e) {
          return e.value;
        })
  ...
  function processInputValue(e, t, n, r, o) {
    if (null != r && !haveSeenNode(e, r)) {
      if ((e.push(r), shouldInclude(r))) {
        (addValueToFormData(
          getRawAttribute(r, "name"),
          getValueFromInput(r),
          t,
        ),
      ...
      r instanceof HTMLFormElement &&
        (forEach(r.elements, function (r) {
          (e.indexOf(r) >= 0
            ? removeValueFromFormData(r.name, getValueFromInput(r), t)
            : e.push(r),
            o && validateElement(r, n));
        }),
        new FormData(r).forEach(function (e, n) {
          (e instanceof File && "" === e.name) || addValueToFormData(n, e, t);
        }));
    }
  }
  ...
  function getInputValues(e, t) {
    const n = [],
      ...
      a = getInternalData(e);
    a.lastButtonClicked &&
      !bodyContains(a.lastButtonClicked) &&
      (a.lastButtonClicked = null);
    let i =
      (e instanceof HTMLFormElement && !0 !== e.noValidate) ||
      "true" === getAttributeValue(e, "hx-validate");
    if (
      (a.lastButtonClicked &&
        (i = i && !0 !== a.lastButtonClicked.formNoValidate),
      "get" !== t && processInputValue(n, o, s, getRelatedForm(e), i),
      processInputValue(n, r, s, e, i),
      a.lastButtonClicked ||
        "BUTTON" === e.tagName ||
        ("INPUT" === e.tagName && "submit" === getRawAttribute(e, "type")))
    ) {
      const t = a.lastButtonClicked || e;
      addValueToFormData(getRawAttribute(t, "name"), t.value, o);
    }
    return (
      forEach(findAttributeTargets(e, "hx-include"), function (e) {
        (processInputValue(n, r, s, asElement(e), i),
          matches(e, "form") ||
            forEach(
              asParentNode(e).querySelectorAll(INPUT_SELECTOR),
              function (e) {
                processInputValue(n, r, s, e, i);
              },
            ));
      ...
      { errors: s, formData: r, values: formDataProxy(r) }
    );
  }
  ...
  function filterValues(e, t) {
    ...
    if (n) {
      ...
      if (0 === n.indexOf("not "))
        return (
          forEach(n.slice(4).split(","), function (t) {
            ((t = t.trim()), e.delete(t));
          }),
          e
        );
  ...
  function getSwapSpecification(e, t) {
    ...
    if (
      ...
      const e = splitOnWhitespace(n);
      if (e.length > 0)
        for (let t = 0; t < e.length; t++) {
          const n = e[t];
          if (0 === n.indexOf("swap:")) r.swapDelay = parseInterval(n.slice(5));
          else if (0 === n.indexOf("settle:"))
            r.settleDelay = parseInterval(n.slice(7));
          else if (0 === n.indexOf("transition:"))
            r.transition = "true" === n.slice(11);
          else if (0 === n.indexOf("ignoreTitle:"))
            r.ignoreTitle = "true" === n.slice(12);
          else if (0 === n.indexOf("scroll:")) {
            const e = (s = n.slice(7).split(":")).pop();
            var o = s.length > 0 ? s.join(":") : null;
            ((r.scroll = e), (r.scrollTarget = o));
          } else if (0 === n.indexOf("show:")) {
            var s;
            const e = (s = n.slice(5).split(":")).pop();
            o = s.length > 0 ? s.join(":") : null;
            ((r.show = e), (r.showTarget = o));
          } else if (0 === n.indexOf("focus-scroll:")) {
            const e = n.slice(13);
            r.focusScroll = "true" == e;
          } else
            0 == t
              ? (r.swapStyle = n)
              : logError("Unknown modifier in hx-swap: " + n);
        }
    }
    return r;
  }
  function usesFormData(e) {
    return (
      "multipart/form-data" === getClosestAttributeValue(e, "hx-encoding") ||
      (matches(e, "form") &&
        "multipart/form-data" === getRawAttribute(e, "enctype"))
    );
  }
  function encodeParamsForBody(e, t, n) {
    ...
    return (
      withExtensions(t, function (o) {
        null == r && (r = o.encodeParameters(e, n, t));
      }),
      null != r
        ? r
        : usesFormData(t)
  ...
  function updateScrollState(e, t) {
    ...
    if (t.scroll) {
      ...
      (t.scrollTarget && (o = asElement(querySelectorExt(n, t.scrollTarget))),
        "top" === t.scroll && (n || o) && ((o = o || n).scrollTop = 0),
        "bottom" === t.scroll &&
          (r || o) &&
          ((o = o || r).scrollTop = o.scrollHeight),
        "number" == typeof t.scroll &&
          getWindow().setTimeout(function () {
    ...
    if (t.show) {
      ...
      if (t.showTarget) {
        let e = t.showTarget;
        ("window" === t.showTarget && (e = "body"),
          (o = asElement(querySelectorExt(n, e))));
      }
      ("top" === t.show &&
        (n || o) &&
  ...
  function getValuesForElement(e, t, n, r, o) {
    ...
    if (s) {
      ...
      (0 === a.indexOf("javascript:")
        ? ((a = a.slice(11)), (i = !0))
        : 0 === a.indexOf("js:") && ((a = a.slice(3)), (i = !0)),
        0 !== a.indexOf("{") && (a = "{" + a + "}"),
        (t = i
          ? maybeEval(
              e,
              function () {
                return o
                  ? Function("event", "return (" + a + ")").call(e, o)
                  : Function("return (" + a + ")").call(e);
              },
              {},
            )
          : parseJSON(a)));
      for (const e in t) t.hasOwnProperty(e) && null == r[e] && (r[e] = t[e]);
    }
  ...
  function ajaxHelper(e, t, n) {
    if (((e = e.toLowerCase()), n)) {
      if (n instanceof Element || "string" == typeof n)
  ...
  function verifyPath(e, t, n) {
    const r = new URL(
        t,
        "about:" !== location.protocol ? location.href : window.origin,
      ),
      o =
        ("about:" !== location.protocol ? location.origin : window.origin) ===
        r.origin;
    return (
      !(htmx.config.selfRequestsOnly && !o) &&
      triggerEvent(
        e,
        "htmx:validateUrl",
  ...
  function formDataFromObject(e) {
    ...
    for (const n in e)
      e.hasOwnProperty(n) &&
        (e[n] && "function" == typeof e[n].forEach
          ? e[n].forEach(function (e) {
              t.append(n, e);
            })
          : "object" != typeof e[n] || e[n] instanceof Blob
            ? t.append(n, e[n])
      ...
      set: function (e, t, n) {
        return (
          ...
          n && "function" == typeof n.forEach
            ...
            : "object" != typeof n || n instanceof Blob
              ? e.append(t, n)
  ...
  function issueAjaxRequest(e, t, n, r, o, s) {
    let a = null,
      i = null;
    ...
    const c = o.handler || handleAjaxResponse,
      u = o.select || null;
    if (!bodyContains(n)) return (maybeCall(a), l);
    const f = o.targetOverride || asElement(getTarget(n));
    if (null == f || f == DUMMY_ELT)
      return (
    ...
    let g = getInternalData(n);
    const d = g.lastButtonClicked;
    if (d) {
      const n = getRawAttribute(d, "formaction");
      null != n && (t = n);
      const r = getRawAttribute(d, "formmethod");
      if (null != r) {
        if (!VERBS.includes(r.toLowerCase())) return (maybeCall(a), l);
        e = r;
      }
    }
      ...
      if (
        ...
        triggerEvent(n, "htmx:confirm", {
          ...
          issueRequest: function (s) {
            return issueAjaxRequest(e, t, n, r, o, !!s);
          },
          question: h,
        })
      )
        return (maybeCall(a), l);
    }
    let m = n,
    ...
    if (p) {
      ...
      if (
        ((m =
          "this" === t
            ? findThisElement(n, "hx-sync")
            : asElement(querySelectorExt(n, t))),
        (p = (e[1] || "drop").trim()),
        (g = getInternalData(m)),
        "drop" === p && g.xhr && !0 !== g.abortable)
      )
        return (maybeCall(a), l);
      if ("abort" === p) {
        if (g.xhr) return (maybeCall(a), l);
        x = !0;
      } else if ("replace" === p) triggerEvent(m, "htmx:abort");
      else if (0 === p.indexOf("queue")) {
        E = (p.split(" ")[1] || "last").trim();
      }
    }
    if (g.xhr) {
      if (!g.abortable) {
        ...
        return (
          null == g.queuedRequests && (g.queuedRequests = []),
          ("first" === E && 0 === g.queuedRequests.length) || "all" === E
            ? g.queuedRequests.push(function () {
    ...
    ((g.xhr = y), (g.abortable = x));
    const v = function () {
        if (
          ((g.xhr = null),
          (g.abortable = !1),
          null != g.queuedRequests && g.queuedRequests.length > 0)
        ) {
          g.queuedRequests.shift()();
        }
      },
      b = getClosestAttributeValue(n, "hx-prompt");
    if (b) {
      var S = prompt(b);
      if (
        null === S ||
        !triggerEvent(n, "htmx:prompt", { prompt: S, target: f })
      )
        return (maybeCall(a), v(), l);
    }
    if (h && !s && !confirm(h)) return (maybeCall(a), v(), l);
    let w = getHeaders(n, f, S);
    ("get" === e ||
      usesFormData(n) ||
      (w["Content-Type"] = "application/x-www-form-urlencoded"),
      o.headers && (w = mergeObjects(w, o.headers)));
    const C = getInputValues(n, e);
    let A = C.errors;
    const T = C.formData;
    o.values && overrideFormData(T, formDataFromObject(o.values));
    const H = overrideFormData(T, formDataFromObject(getExpressionVars(n, r)));
    let O = filterValues(H, n);
    (htmx.config.getCacheBusterParam &&
      "get" === e &&
      O.set("org.htmx.cache-buster", getRawAttribute(f, "id") || "true"),
      (null != t && "" !== t) || (t = location.href));
    const R = getValuesForElement(n, "hx-request"),
      I = getInternalData(n).boosted;
    let D = htmx.config.methodsThatUseUrlParams.indexOf(e) >= 0;
    const N = {
      boosted: I,
      useUrlParams: D,
      formData: O,
      ...
      errors: A,
      withCredentials:
        o.credentials || R.credentials || htmx.config.withCredentials,
      timeout: o.timeout || R.timeout || htmx.config.timeout,
      path: t,
      triggeringEvent: r,
    };
    if (!triggerEvent(n, "htmx:configRequest", N))
      return (maybeCall(a), v(), l);
    if (
      ((t = N.path),
      (e = N.verb),
      (w = N.headers),
      (O = formDataFromObject(N.parameters)),
      (A = N.errors),
      (D = N.useUrlParams),
      A && A.length > 0)
    )
      return (
        triggerEvent(n, "htmx:validation:halted", N),
        maybeCall(a),
        v(),
        l
      );
    ...
    if (!verifyPath(n, q, N))
      return (
        triggerErrorEvent(n, "htmx:invalidPath", N),
        maybeCall(i),
        v(),
        l
      );
    if (
      (y.open(e.toUpperCase(), q, !0),
      y.overrideMimeType("text/html"),
    ...
    if (
      ((y.onload = function () {
        try {
          const e = hierarchyForElt(n);
          if (
            ((V.pathInfo.responsePath = getPathFromResponse(y)),
            c(n, V),
            !0 !== V.keepIndicators && removeRequestIndicators(M, k),
            ...
            t &&
              (triggerEvent(t, "htmx:afterRequest", V),
              triggerEvent(t, "htmx:afterOnLoad", V));
          }
          maybeCall(a);
        } catch (e) {
          throw (
      ...
      return (maybeCall(a), v(), l);
    var M = addRequestIndicatorClasses(n),
      k = disableElements(n);
    (forEach(["loadstart", "loadend", "progress", "abort"], function (e) {
      forEach([y, y.upload], function (t) {
    ...
    const B = D ? null : encodeParamsForBody(y, n, O);
    return (y.send(B), l);
  }
  function determineHistoryUpdates(e, t) {
    ...
    const s = t.pathInfo.finalRequestPath,
      a = t.pathInfo.responsePath,
      i = t.etc.push || getClosestAttributeValue(e, "hx-push-url"),
      l = t.etc.replace || getClosestAttributeValue(e, "hx-replace-url"),
      c = getInternalData(e).boosted;
    let u = null,
      f = null;
    return (
      i
  ...
  function handleAjaxResponse(e, t) {
    ...
    if (
      ...
      var a = {};
      return (
        0 === e.indexOf("{") && ((e = (a = parseJSON(e)).path), delete a.path),
        (a.push = a.push || "true"),
        void ajaxHelper("get", e, a)
      );
    }
    const i =
    ...
    if (hasHeader(n, /HX-Redirect:/i))
      return (
        ...
        void (i && htmx.location.reload())
      );
    if (i) return ((t.keepIndicators = !0), void htmx.location.reload());
    const l = determineHistoryUpdates(e, t),
      c = resolveResponseHandling(n),
      u = c.swap;
    let f = !!c.error,
      g = htmx.config.ignoreTitle || c.ignoreTitle,
      d = c.select;
    c.target && (t.target = resolveRetarget(e, c.target));
    var h = o.swapOverride;
    (null == h && c.swapOverride && (h = c.swapOverride),
      hasHeader(n, /HX-Retarget:/i) &&
        (t.target = resolveRetarget(e, n.getResponseHeader("HX-Retarget"))),
      hasHeader(n, /HX-Reswap:/i) && (h = n.getResponseHeader("HX-Reswap")));
    var m = n.response,
      p = mergeObjects(
        {
          shouldSwap: u,
    ...
    if (
      (!c.event || triggerEvent(r, c.event, p)) &&
      ...
      if (
        ...
        (286 === n.status && cancelPolling(e),
          withExtensions(e, function (t) {
            m = t.transformResponse(m, n, e);
          }),
          l.type && saveCurrentPageToHistory());
        var E = getSwapSpecification(e, h);
        (E.hasOwnProperty("ignoreTitle") || (E.ignoreTitle = g),
          r.classList.add(htmx.config.swappingClass),
          s && (d = s),
          hasHeader(n, /HX-Reselect:/i) &&
            (d = n.getResponseHeader("HX-Reselect")));
        const a = o.selectOOB || getClosestAttributeValue(e, "hx-select-oob"),
          i = getClosestAttributeValue(e, "hx-select");
        swap(r, m, E, {
          select: "unset" === d ? null : d || i,
          selectOOB: a,
          eventInfo: t,
          ...
          afterSwapCallback: function () {
            if (hasHeader(n, /HX-Trigger-After-Swap:/i)) {
              let t = e;
              (bodyContains(e) || (t = getDocument().body),
                handleTriggerHeader(n, "HX-Trigger-After-Swap", t));
            }
          },
          afterSettleCallback: function () {
            if (hasHeader(n, /HX-Trigger-After-Settle:/i)) {
              let t = e;
              (bodyContains(e) || (t = getDocument().body),
                handleTriggerHeader(n, "HX-Trigger-After-Settle", t));
            }
          },
  ...
  var isReady = !1;
  function ready(e) {
    isReady || "complete" === getDocument().readyState
      ? e()
      : getDocument().addEventListener("DOMContentLoaded", e);
  }
  function insertIndicatorStyles() {
    if (!1 !== htmx.config.includeIndicatorStyles) {
  ...
  return (
    ...
    ready(function () {
      ...
      e.addEventListener("htmx:abort", function (e) {
        const t = getInternalData(e.detail.elt || e.target);
        t && t.xhr && t.xhr.abort();
      });
